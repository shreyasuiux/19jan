  ...
  return (
    <div className="fixed inset-0 z-[1100] bg-black overflow-y-auto">
      ...
      <div className="relative z-[1200]">
        ...
        <MobileNav onClose={onClose} onServiceClick={onServiceClick} onAIClick={onAIClick} onProductClick={onProductClick} onGrowWithUsClick={onGrowWithUsClick} onWhoWeAreItemClick={onWhoWeAreItemClick} onLogoClick={onLogoClick} />
      </div>
